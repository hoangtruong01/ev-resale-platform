<template>
  <div>
    ...
    >
      <!-- Header -->
      <div
        class="bg-gradient-to-r from-emerald-500 via-green-500 to-teal-600 text-white p-4 flex-shrink-0"
      >
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-emerald-100 text-xs opacity-90">
      ...
      <div class="flex flex-col" style="height: calc(100% - 80px)">
        ...
        >
          ...
          >
            <div class="flex items-end space-x-2 max-w-[85%]">
              ...
              <div v-if="message.sender === 'ai'" class="flex-shrink-0 mb-1">
                <div
                  class="w-8 h-8 bg-gradient-to-br from-emerald-400 to-green-500 rounded-full flex items-center justify-center shadow-sm"
                >
                  <svg
              ...
              <div v-if="message.sender === 'user'" class="flex-shrink-0 mb-1">
                <div
                  class="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center shadow-sm"
                >
                  <svg
                    class="w-4 h-4 text-white"
                    fill="none"
          ...
          <div v-if="isTyping" class="flex justify-start animate-fade-in">
            <div class="flex items-end space-x-2 max-w-[85%]">
              ...
              <div
                class="bg-gray-50 border border-gray-200 p-4 rounded-2xl rounded-bl-sm shadow-sm"
              >
        ...
        <div
          class="border-t border-gray-100 p-4 bg-white rounded-b-2xl flex-shrink-0"
          style="min-height: 80px"
        >
          <!-- Input Row - ALWAYS VISIBLE WITH STRONG STYLING -->
          <div
            class="flex gap-2 items-center bg-gray-50 p-3 rounded-xl border-2 border-gray-300 mb-2"
          >
            <input
          ...
          <div class="text-center">
            <span class="text-xs text-gray-500 font-medium">
              🚗 Chuyên gia xe điện toàn diện • Enter để gửi •
...
const { formatTime: formatLocaleTime } = useLocaleFormat();
...
const sendMessage = async () => {
  if (!inputMessage.value || !inputMessage.value.trim() || isTyping.value)
    return;
  ...
  try {
    ...
    const friendly =
      ...
      "😔 Xin lỗi, tôi gặp sự cố kỹ thuật. Vui lòng thử lại sau một chút.";
