...
final kycStatusProvider = FutureProvider.autoDispose<Map<String, dynamic>>((
  ref,
) async {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final formData = FormData.fromMap({
        ...
        'idType': _idType,
        'fullNameOnId': _fullNameCtrl.text.trim().isNotEmpty
            ? _fullNameCtrl.text.trim()
            : null,
        'idIssuePlace': _issuePlaceCtrl.text.trim().isNotEmpty
      ...
      setState(() {
        _successMsg =
            'Đã nộp hồ sơ! Vui lòng chờ xét duyệt (1–3 ngày làm việc).';
        _isSubmitting = false;
      });
