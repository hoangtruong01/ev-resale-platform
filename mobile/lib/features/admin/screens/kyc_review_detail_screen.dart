...
class KycReviewDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<KycReviewDetailScreen> createState() => _KycReviewDetailScreenState();
}
  ...
  Future<void> _submitDecision(String decision) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(decision == 'APPROVED' ? 'Đã duyệt thành công!' : 'Đã từ chối yêu cầu.'),
            backgroundColor: decision == 'APPROVED' ? AppTheme.success : AppTheme.orange500,
          ),
        );
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: user?['avatar'] == null
                        ? const Icon(Icons.person, size: 35, color: AppTheme.primaryGreen)
                        : null,
                  ),
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: const TextStyle(fontSize: 14, color: AppTheme.grey400),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _isSubmitting ? null : () => _submitDecision('APPROVED'),
        ...
        children: [
          ...
          if (imageUrl != null)
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) => Container(
                    ...
                    child: const Center(
                      child: Icon(Icons.broken_image_outlined, color: AppTheme.grey400, size: 40),
                    ),
                  ),
            ...
            const Padding(
              ...
              child: Center(
                child: Text('Không có hình ảnh', style: TextStyle(color: AppTheme.grey400, fontSize: 13)),
              ),
            ),
        ],
      ),
